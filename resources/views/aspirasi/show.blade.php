...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-3xl mx-auto">
        ...
        <div class="mt-8 border-t pt-6">
            <h2 class="text-xl font-semibold mb-4 text-gray-800">Komentar</h2>
                ...
                <div class="flex items-start space-x-2">
                    <div class="flex-1">
                        <textarea
                            name="isi"
                            rows="3"
                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('isi') border-red-500 @enderror"
                    ...
                    <button
                        type="submit"
                        class="mt-1 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out"
                    >
                        Kirim
                    </button>
                </div>
            ...
            @else
            <div class="mb-6 p-3 bg-blue-50 rounded-lg text-center">

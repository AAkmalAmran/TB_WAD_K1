...
<head>
    ...
    <title>Buat Berita Baru - U-Voice Telkom University</title>
...
<body class="bg-telkom-gray font-sans min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-4 flex-grow">
        <div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-lg border-t-4 border-telkom-red">
            <h2 class="text-2xl font-bold mb-6 text-telkom-red text-center">Buat Berita Baru</h2>
            <form action="{{ route('berita.store') }}" method="POST">
                @csrf
                <div class="mb-5">
                    <label class="block mb-1 font-semibold text-gray-700">Judul</label>
                    <input type="text" name="judul" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-telkom-red focus:outline-none" required>
                </div>
                <div class="mb-6">
                    <label class="block mb-1 font-semibold text-gray-700">Isi Berita</label>
                    <textarea name="isi" rows="7" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-telkom-red focus:outline-none" required></textarea>
                </div>
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="bg-telkom-red hover:bg-telkom-red-dark text-white px-8 py-2 rounded-lg font-semibold transition">Simpan</button>
                </div>
            </form>
        </div>
    </main>
